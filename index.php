                        ...
                        <div class="tab-content card">
                                ...
                                <form action="register.php" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12 d-flex justify-content-between login_option">
                                            ...
                                            <button type="" class="btn btn-default login_btn" name="login2">Login</button>
                                        </div> 
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                            ...
                            <div class="tab-pane fade" id="panel2" role="tabpanel">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" placeholder="Password" name="upload">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label  class="control-label">Role Name</label>
                                                <select name="course" id="" class="sun">
                                                <?php
                                include "connect.php";
                                $query = mysqli_query($connection, "select * from role where role_name IN ('DIT','PDIT','CIT')");
                                ...
                                ?>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12 d-flex justify-content-between login_option">
                                            <button type="submit" class="btn btn-default login_btn" name="login">Register</button>
                                        </div> 
                                    </div>
                                </form>
                                ...
                                if(isset($_POST['login']) && !empty($_FILES["upload"]["name"])){
                                    $role = $_POST['course'];
                                    $name = $_POST['username'];
                                    $email = $_POST['email'];
                                    $pass = $_POST['pass'];
                                    ...
                                    $final = $imagefolder .$imagename;

                                    if($name && $email && $pass == !null){

                                    (move_uploaded_file($_FILES["upload"]["tmp_name"],$final));
                                
                                $query = mysqli_query($connection, "insert into student (name,email,password,picture,std_id) value('$name','$email','$pass','".$imagename."','$role')");
                                if($query){
